...
export default function ProjectCard({ project }: { project: Project }) {
  return (
    <motion.div
      ...
      className="group flex flex-col rounded-2xl border border-slate-200 dark:border-white/8 overflow-hidden bg-white dark:bg-slate-800/40 hover:border-emerald-500/40 hover:shadow-xl hover:shadow-emerald-500/10 transition-all duration-300 h-full"
    >
      ...
      <div className="p-6 space-y-4 flex flex-col flex-1">
        ...
        <div className="flex gap-4 pt-2 border-t border-slate-100 dark:border-white/5">
          {project.githubUrl && (
            <a
